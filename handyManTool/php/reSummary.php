...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($button=="Submit")
	{
		...
		header('Location: reservationFinal.php');
		exit();
	}
	else
	{
		...
		if($result==1)
		{
			...
			{
				$errorMsg = "Error Deleting Reservation, Please Try Again";
			}
		}
		else
		{
			$errorMsg = "Error Deleting Reserved Tools, Please Try Again";
		}
	}
}
			...
			<div class="center_content">
				<div class="text_box">
				  ...
				  ?>
					...
					<br>
					<br>
					<form action="reSummary.php" method="post">
